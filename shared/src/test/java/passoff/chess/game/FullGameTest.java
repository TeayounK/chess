...
public class FullGameTest {
    ...
    // new test case made by TA who blamed me on knowing nothing.
    @Test
    @DisplayName("Full Game Checkmate")
    public void dup() {
        ChessBoard board = new ChessBoard();
        board.addPiece(new ChessPosition(2,3), new ChessPiece(ChessGame.TeamColor.BLACK, ChessPiece.PieceType.ROOK));
        ChessBoard clone = board.duplicate();
        Assertions.assertEquals(board, clone, "Cloning function works");
    }
